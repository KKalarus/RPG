			...
			do {
				...
				case 'r':
					...
					if (runAway()) {
						...
						LIME; cout << "UDA£O CI SIÊ UCIEC!";
						Sleep(1500);
					}
					else {
						LIME; cout << "NIE UDA£O CI SIÊ UCIEC!";
					}
					y++;
					turnEnded = true;
					break;
				case 'm':
					...
					potion = drinkMP();
					if (potion==1){
						BLUE; cout << "WYPI£EŒ MIKSTURÊ MANY!";
						gotoxy(63, 33);
						BLUE; cout << "MANA: "; WHITE;
						gotoxy(78, 33);
						cout << "              ";
						...
						BLUE; cout << "MASZ MAKSYMALN¥ ILOŒÆ MANY!";
					}
					else if (potion == -1) {
				...
				case 'h':
					...
					potion = drinkHP();
					if (potion == 1){
						RED; cout << "WYPI£EŒ MIKSTURÊ ¯YCIA!";
						gotoxy(63, 32);
						BLUE; cout << "HP: "; WHITE;
						gotoxy(78, 32);
						cout << "              ";
						...
						RED; cout << "MASZ MAKSYMALN¥ ILOŒÆ ¯YCIA!";
					}
					else if (potion == -1) {
			...
			if (!playerRanAway) {
				if(przeciwnik.runOrFight()){
					...
					if (getDamage(dmg)) {
						...
						LIME; cout << "UNIKN¥£EŒ CIOSU PRZECIWNIKA!";
					}
					y++;
				}
				turnEnded = false;
...
/*	gotoxy(60, 16);
	...
	gotoxy(60, 17);
	cout << "CHCESZ KUPIÆ CZY SPRZEDAÆ?";
	gotoxy(60, 18);
